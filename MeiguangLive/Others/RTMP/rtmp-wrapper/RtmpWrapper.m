...
//      sent = RTMP_Write(_rtmp, [data bytes], (int)[data length]);
        ...
        RTMPPacket_Alloc(&packet,(uint32_t)[data length]);
        ...
        packet.m_nBodySize = (uint32_t)[data length];
        memcpy(packet.m_body, [data bytes], [data length]);
        
        sent = RTMP_SendPacket(_rtmp,&packet,0);
